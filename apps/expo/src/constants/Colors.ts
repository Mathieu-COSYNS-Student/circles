...
const theme = {
  light: {
    ...
    chatToolbarInputBackground: tailwindColors.gray[50],
    chatToolbarInputBorder: tailwindColors.gray[300],
  ...
  dark: {
    ...
    chatToolbarInputBackground: tailwindColors.zinc[900],
    chatToolbarInputBorder: tailwindColors.zinc[800],
